...
Wall3=createSprite(400,126,20,10);
...
box8.display()
 ...
 coin.display()
  ...
  function isTouching(laserBeam,laserBeam2){
    if (laserBeam.x - laserBeam2.x < laserBeam2.width/2 + laserBeam.width/2
      && laserBeam2.x - laserBeam.x < laserBeam2.width/2 + laserBeam.width/2
      && laserBeam.y - laserBeam2.y < laserBeam2.height/2 + laserBeam.height/2
      && laseBeam2.y - laseBeam2.y < laseBeam2.height/2 + laseBeam.height/2) {
